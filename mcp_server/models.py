...
class CertificateParameters(BaseModel):
    ...
    SCNO: str = Field(..., description='SC_NO', examples=['APSID00040466'])
...
class EpfscCertificatePostRequest(BaseModel):
...
class EpfscCertificatePostResponse(BaseModel):
...
class EpfscCertificatePostResponse1(BaseModel):
...
class EpfscCertificatePostResponse2(BaseModel):
...
class EpfscCertificatePostResponse3(BaseModel):
...
class EpfscCertificatePostResponse4(BaseModel):
...
class EpfscCertificatePostResponse5(BaseModel):
...
class EpfscCertificatePostResponse6(BaseModel):
...
class CertificateParameters1(BaseModel):
    ...
    PPONO: str = Field(..., description='PPO NO', examples=['DLCPM00052882'])
...
class CertificateParameters2(BaseModel):
    ...
    UAN: str = Field(..., description='UAN NUMBER', examples=['10000003577'])


class UncrdCertificatePostRequest(BaseModel):
...
class UncrdCertificatePostResponse(BaseModel):
...
class UncrdCertificatePostResponse1(BaseModel):
...
class UncrdCertificatePostResponse2(BaseModel):
...
class UncrdCertificatePostResponse3(BaseModel):
...
class UncrdCertificatePostResponse4(BaseModel):
...
class UncrdCertificatePostResponse5(BaseModel):
...
class UncrdCertificatePostResponse6(BaseModel):
